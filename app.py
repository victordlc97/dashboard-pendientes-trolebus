...
DATA = [
    ("Contrato 1", "LP-SITRAMYTEM-DPPC-PAD-02-2023", "José Antonio", "Planos as-built", "Documentación", "En curso",
     "Actualizar los planos con el estado real de la obra; falta la firma de Supervisión y definir la fecha de entrega."),
    ("Contrato 1", "LP-SITRAMYTEM-DPPC-PAD-02-2023", "José Antonio", "Dossier de Calidad", "Documentación", "En curso", ""),
    ("Contrato 1", "LP-SITRAMYTEM-DPPC-PAD-02-2023", "CUPISA", "Bitácora de obra", "Documentación", "Urgente",
    ...
    ("Contrato 1", "LP-SITRAMYTEM-DPPC-PAD-02-2023", "SITRAMYTEM/MGMG", "Documentos de Terminación Anticipada", "Administrativo", "En curso",
     "Elaborar la documentación para dar paso a los convenios correspondientes."),
    ("Contrato 1", "LP-SITRAMYTEM-DPPC-PAD-02-2023", "—", "Revisión de expediente", "Administrativo", "Pendiente",
     "Revisar qué cuestiones administrativas siguen abiertas."),
    ("Contrato 1", "LP-SITRAMYTEM-DPPC-PAD-02-2023", "—", "Retroalimentación de SITRAMYTEM GNR", "Coordinación", "Pendiente",
    ...
    ("Contrato 2", "LP-SITRAMYTEM-DPPC-PAD-06-2024", "José Antonio", "Planos as-built", "Documentación", "En curso",
     "Actualizar los planos con el estado real de la obra; falta la firma de Supervisión y definir la fecha de entrega."),
    ("Contrato 2", "LP-SITRAMYTEM-DPPC-PAD-06-2024", "José Antonio", "Dossier de Calidad", "Documentación", "Pendiente", ""),
    ("Contrato 2", "LP-SITRAMYTEM-DPPC-PAD-06-2024", "MGMG/CUPISA", "Bitácora de obra", "Documentación", "Urgente",
    ...
    ("Contrato 2", "LP-SITRAMYTEM-DPPC-PAD-06-2024", "—", "Revisión de expediente", "Administrativo", "Pendiente",
     "Revisar qué cuestiones administrativas siguen abiertas."),
    ("Contrato 2", "LP-SITRAMYTEM-DPPC-PAD-06-2024", "—", "Retroalimentación de SITRAMYTEM GNR", "Coordinación", "Pendiente",
     "Está en espera de respuesta por parte de SITRAMYTEM; se presentó hace menos de un mes."),
    ("Contrato 2", "LP-SITRAMYTEM-DPPC-PAD-06-2024", "INDIMA/CUPISA", "Precios extraordinarios", "Financiero", "Pendiente",
